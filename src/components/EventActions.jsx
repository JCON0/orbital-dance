...
const EventActions = ({ isSaved, onSave }) => {
  ...
  return (
    <div className="flex gap-4">
      ...
      <button 
        onClick={handleShare}
        className="rounded-lg border border-slate-300 px-6 py-4 text-slate-700 transition hover:bg-slate-50 dark:border-slate-700 dark:text-slate-300 dark:hover:bg-slate-800"
      >
      ...
      <button 
        onClick={onSave}
        className="rounded-lg border border-slate-300 px-6 py-4 text-slate-100 transition hover:bg-slate-50 dark:border-slate-700 dark:text-slate-300 dark:hover:bg-slate-800"
